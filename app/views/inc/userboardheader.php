    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <li class="nav-item">
          ...
          <a href="<?php echo URLROOT; ?>userboard/index"class="nav-link active">Tableau de bord</a>
          </li>
          <li class="nav-item px-1">
            <a href="<?php echo URLROOT; ?>userboardflows/index" class="nav-link">Cours </a>
          </li>
          <li class="nav-item pl-5  ml-5 ">
          <a href="<?php echo URLROOT; ?>userboard/showprofil/<?php echo  $_SESSION['user_id']; ?>" class="nav-link  text-danger ml-5"<strong><?php echo $_SESSION['user_name']; ?></strong></a>
          </li>
        </ul>
